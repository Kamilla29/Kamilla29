...
A shared design-token architecture for **web and game user interfaces**.

**Highlights:**
- layered token architecture: primitives → semantics → component contracts → platform adapters
- platform-specific Web and Game outputs generated from one semantic core
- interactive browser model cases
- native Godot 4 integration
- EN/CZ localization
- automated validation and architecture checks
- GitHub Actions CI
